...
export default function MessageList({ messages, status, bottomRef }: MessageListProps) {
  ...
  return (
    <div className="flex flex-col gap-6 p-6 h-[calc(100vh-20.5rem)] overflow-y-auto bg-black text-white">
      {messages.length === 0 && !isLoading && (
        <div className="flex flex-col items-center justify-center h-full text-center animate-fadeIn">
          <div className="w-16 h-16 bg-gray-800 rounded-2xl flex items-center justify-center mb-4">
            <Bot className="w-8 h-8 text-white" />
          </div>
          <h3 className="text-xl font-semibold mb-2">Welcome to QueueChat AI</h3>
          ...
          <div key={message.id} className="animate-slideIn">
            {/* {isRoleChange && (
              <div className="flex items-center gap-3 my-6">
                ...
                <div className="text-xs text-gray-500 px-3 py-1 bg-gray-900 rounded-full">
            ...
            >
              {message.role === 'assistant' && (
                <div className="w-10 h-10 bg-gray-800 rounded-xl flex items-center justify-center shadow-lg flex-shrink-0">
              ...
              <div
                className={`max-w-[80%] px-5 py-4 rounded-2xl text-sm leading-relaxed shadow-lg ${
                  message.role === 'user'
                    ...
                    : 'bg-gray-900 text-gray-100 border border-gray-700 rounded-bl-md'
                }`}
              >
                {message.parts.map(
              ...
              {message.role === 'user' && (
                <div className="w-10 h-10 bg-gray-600 rounded-xl flex items-center justify-center shadow-lg flex-shrink-0">
      ...
      {isLoading && (
        <div className="flex gap-3 items-end justify-start animate-fadeIn">
          ...
          <div className="bg-gray-900 rounded-2xl px-5 py-4 border border-gray-700 shadow-lg">
